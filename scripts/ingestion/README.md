...
- `embed_and_load.py`: Main orchestrator script that validates metadata schemas, skips unsupported subjects (free tier limits), generates 768-dimensional float embedding coordinates, and runs transactional SQL inserts.
